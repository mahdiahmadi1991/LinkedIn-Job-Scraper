...
- The ownership migration/backfill behavior and rollback options are documented in `docs/operations/troubleshooting.md` under `Per-User Isolation and Ownership Migration`.
